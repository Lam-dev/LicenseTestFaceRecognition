...
class Ui_Frame_MainScreen(object):
    def setupUi(self, Frame_MainScreen):
        ...
        Frame_MainScreen.resize(793, 480)
...
"border-radius:2px;")
        ...
        self.frame.setGeometry(QtCore.QRect(344, 66, 441, 205))
...
"border-radius:8")
        ...
        self.frame_3.setGeometry(QtCore.QRect(8, 66, 329, 405))
...
"")
        ...
        self.frame_containWarning.setGeometry(QtCore.QRect(344, 280, 441, 191))
